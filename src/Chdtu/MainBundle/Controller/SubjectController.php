...
use Chdtu\MainBundle\Entity\Subject;
use Chdtu\MainBundle\Form\SubjectType;
...
class SubjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ChdtuMainBundle:Subject')->findAll();

        return $this->render('ChdtuMainBundle:Subject:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ChdtuMainBundle:Subject:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ChdtuMainBundle:Subject')->find($id);
        ...
        return $this->render('ChdtuMainBundle:Subject:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ChdtuMainBundle:Subject:edit.html.twig', array(
            'entity'      => $entity,
