...
doCliAction('Create database schema', 'php app/console doctrine:schema:update --force');
...
//doCliAction('Create admin user', 'php app/console fos:user:create admin admin@example.com admin --super-admin');
doCliAction('Changing permissions', 'sudo chmod -R 777 app/cache app/logs web/');
